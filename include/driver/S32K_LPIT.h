...
#ifndef DRIVER_S32K_LPIT_H_
#define DRIVER_S32K_LPIT_H_
//==============================================================================
//                               INCLUDES
//==============================================================================
#include "include.h"
...
//==============================================================================
/*
 * @brief: Initialize the Low-Power Interrupt Timer
 * @param: channel: timer channel
 */
void LPIT_init(uint8_t channel);

/*
 * @brief: Start the Low-Power Interrupt Timer
 * @param: channel: timer channel
 */
void LPIT_startChannel(uint8_t channel);

#endif /* DRIVER_S32K_LPIT_H_ */
